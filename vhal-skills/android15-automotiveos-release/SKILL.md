...
- **AIDL Summary**: Measured distance from leading vehicle when using Adaptive Cruise Control (ACC)
- **Change Mode**: VehiclePropertyChangeMode.CONTINUOUS
- **Access**: VehiclePropertyAccess.READ
- **Unit**: VehicleUnit.MILLIMETER
- **Requires Permission (Read)**: Car.PERMISSION_READ_ADAS_STATES
- **Protection Level**: signature|privileged
- **Version**: 2
...
- **AIDL Summary**: Current target time gap for Adaptive Cruise Control (ACC) or Predictive Cruise Control
- **Change Mode**: VehiclePropertyChangeMode.ON_CHANGE
- **Access**: VehiclePropertyAccess.READ_WRITE, VehiclePropertyAccess.READ
- **Unit**: VehicleUnit.MILLI_SECS
- **Requires Permission (Read)**: Car.PERMISSION_READ_ADAS_STATES OR Car.PERMISSION_CONTROL_ADAS_STATES
- **Requires Permission (Write)**: Car.PERMISSION_CONTROL_ADAS_STATES
- **Protection Level**: signature|privileged
- **Version**: 2
...
- **Change Mode**: VehiclePropertyChangeMode.ON_CHANGE
- **Access**: VehiclePropertyAccess.READ_WRITE, VehiclePropertyAccess.READ
- **Requires Permission (Read)**: Car.PERMISSION_READ_ADAS_SETTINGS OR Car.PERMISSION_CONTROL_ADAS_SETTINGS
- **Requires Permission (Write)**: Car.PERMISSION_CONTROL_ADAS_SETTINGS
- **Protection Level**: signature|privileged
- **Version**: 2
- **Default Value**: {int32Values: [0]}
- **Data Type**: int32
...
- **Requires Permission (Read)**: Car.PERMISSION_READ_DISPLAY_UNITS
- **Requires Permission (Write)**: Car.PERMISSION_CONTROL_DISPLAY_UNITS OR Car.PERMISSION_VENDOR_EXTENSION
- **Protection Level**: signature|privileged, normal
- **Version**: 1
...
- **Data Enums**:
  ...
  - **ErrorState**: OTHER_ERROR_STATE = -1, NOT_AVAILABLE_DISABLED = -2, NOT_AVAILABLE_SPEED_LOW = -3, NOT_AVAILABLE_SPEED_HIGH = -4, NOT_AVAILABLE_POOR_VISIBILITY = -5, NOT_AVAILABLE_SAFETY = -6
- **Requires Permission (Read)**: Car.PERMISSION_READ_DRIVER_MONITORING_STATES
- **Protection Level**: signature|privileged
- **Version**: 3
...
- **Change Mode**: VehiclePropertyChangeMode.ON_CHANGE
- **Access**: VehiclePropertyAccess.READ_WRITE, VehiclePropertyAccess.READ
- **Requires Permission (Read)**: Car.PERMISSION_READ_DRIVER_MONITORING_SETTINGS OR Car.PERMISSION_CONTROL_DRIVER_MONITORING_SETTINGS
- **Requires Permission (Write)**: Car.PERMISSION_CONTROL_DRIVER_MONITORING_SETTINGS
- **Protection Level**: signature|privileged
- **Version**: 3
- **Default Value**: {int32Values: [1]}
- **Data Type**: int32
...
- **Change Mode**: VehiclePropertyChangeMode.ON_CHANGE
- **Access**: VehiclePropertyAccess.READ_WRITE, VehiclePropertyAccess.READ
- **Requires Permission (Read)**: Car.PERMISSION_CAR_DYNAMICS_STATE OR Car.PERMISSION_CONTROL_CAR_DYNAMICS_STATE
- **Requires Permission (Write)**: Car.PERMISSION_CONTROL_CAR_DYNAMICS_STATE
- **Protection Level**: signature|privileged
- **Version**: 3
- **Default Value**: {int32Values: [1]}
- **Data Type**: int32
...
- **Data Enums**:
  ...
  - **ErrorState**: OTHER_ERROR_STATE = -1, NOT_AVAILABLE_DISABLED = -2, NOT_AVAILABLE_SPEED_LOW = -3, NOT_AVAILABLE_SPEED_HIGH = -4, NOT_AVAILABLE_POOR_VISIBILITY = -5, NOT_AVAILABLE_SAFETY = -6
- **Requires Permission (Read)**: Car.PERMISSION_CAR_DYNAMICS_STATE
- **Protection Level**: signature|privileged
- **Version**: 3
...
- **Requires Permission (Read)**: Car.PERMISSION_CAR_ENGINE_DETAILED
- **Protection Level**: signature|privileged
- **Version**: 1
...
- **Access**: VehiclePropertyAccess.READ
- **Unit**: VehicleUnit.CELSIUS
- **Requires Permission (Read)**: Car.PERMISSION_ENERGY
...
- **Change Mode**: VehiclePropertyChangeMode.ON_CHANGE
- **Access**: VehiclePropertyAccess.READ_WRITE, VehiclePropertyAccess.READ
- **Requires Permission (Read)**: Car.PERMISSION_POWERTRAIN OR Car.PERMISSION_CONTROL_POWERTRAIN
- **Requires Permission (Write)**: Car.PERMISSION_CONTROL_POWERTRAIN
- **Protection Level**: signature|privileged, normal
- **Version**: 2
- **Default Value**: {int32Values: [0]}
- **Areas**:
...
- **Requires Permission (Read)**: Car.PERMISSION_ENERGY OR Car.PERMISSION_CONTROL_CAR_ENERGY
- **Requires Permission (Write)**: Car.PERMISSION_CONTROL_CAR_ENERGY
- **Protection Level**: signature|privileged, dangerous
- **Version**: 1
...
- **Change Mode**: VehiclePropertyChangeMode.ON_CHANGE
- **Access**: VehiclePropertyAccess.READ_WRITE, VehiclePropertyAccess.READ
- **Requires Permission (Read)**: Car.PERMISSION_ENERGY_PORTS OR Car.PERMISSION_CONTROL_ENERGY_PORTS
- **Requires Permission (Write)**: Car.PERMISSION_CONTROL_ENERGY_PORTS
- **Protection Level**: signature|privileged, normal
- **Version**: 1
- **Default Value**: {int32Values: [0]}
- **Data Type**: int32
...
- **Change Mode**: VehiclePropertyChangeMode.ON_CHANGE
- **Access**: VehiclePropertyAccess.READ_WRITE, VehiclePropertyAccess.READ
- **Requires Permission (Read)**: Car.PERMISSION_READ_HEAD_UP_DISPLAY_STATUS OR Car.PERMISSION_CONTROL_HEAD_UP_DISPLAY
- **Requires Permission (Write)**: Car.PERMISSION_CONTROL_HEAD_UP_DISPLAY
- **Protection Level**: signature|privileged
- **Version**: 3
- **Default Value**: {int32Values: [0]}
- **Areas**:
...
- **Data Enums**:
  - **VehicleUnit**: SHOULD_NOT_USE = 0x000, METER_PER_SEC = 0x01, RPM = 0x02, HERTZ = 0x03, PERCENTILE = 0x10, MILLIMETER = 0x20, METER = 0x21, KILOMETER = 0x23, MILE = 0x24, CELSIUS = 0x30, FAHRENHEIT = 0x31, KELVIN = 0x32, MILLILITER = 0x40, LITER = 0x41, GALLON = 0x42, US_GALLON = 0x42, IMPERIAL_GALLON = 0x43, NANO_SECS = 0x50, MILLI_SECS = 0x51, SECS = 0x53, YEAR = 0x59, WATT_HOUR = 0x60, MILLIAMPERE = 0x61, MILLIVOLT = 0x62, MILLIWATTS = 0x63, AMPERE_HOURS = 0x64, KILOWATT_HOUR = 0x65, AMPERE = 0x66, KILOPASCAL = 0x70, PSI = 0x71, BAR = 0x72, DEGREES = 0x80, MILES_PER_HOUR = 0x90, KILOMETERS_PER_HOUR = 0x91
- **Requires Permission (Read)**: Car.PERMISSION_READ_DISPLAY_UNITS OR Car.PERMISSION_CONTROL_CAR_CLIMATE
- **Requires Permission (Write)**: Car.PERMISSION_CONTROL_CAR_CLIMATE
- **Protection Level**: signature|privileged, normal
- **Version**: 1
...
- **Requires Permission (Read)**: Car.PERMISSION_READ_IMPACT_SENSORS
- **Protection Level**: signature|privileged
- **Version**: 3
- **Default Value**: {int32Values: [0]}
- **Areas**:
...
- **Requires Permission (Read)**: Car.PERMISSION_ENERGY OR Car.PERMISSION_ADJUST_RANGE_REMAINING
- **Requires Permission (Write)**: Car.PERMISSION_ADJUST_RANGE_REMAINING
- **Protection Level**: signature|privileged, dangerous
- **Version**: 1
...
- **Requires Permission (Read)**: Car.PERMISSION_READ_CAR_AIRBAGS
- **Protection Level**: signature|privileged
- **Version**: 3
- **Default Value**: {int32Values: [0]}
- **Areas**:
...
- **Change Mode**: VehiclePropertyChangeMode.ON_CHANGE
- **Access**: VehiclePropertyAccess.READ
- **Requires Permission (Read)**: Car.PERMISSION_READ_CAR_SEAT_BELTS
- **Protection Level**: signature|privileged
- **Version**: 3
- **Default Value**: {int32Values: [0]}
- **Areas**:
...
- **Data Enums**:
  - **VehicleLightState**: OFF = 0, ON = 1, DAYTIME_RUNNING = 2
- **Requires Permission (Read)**: Car.PERMISSION_READ_INTERIOR_LIGHTS
- **Protection Level**: signature|privileged
- **Version**: 2
- **Default Value**: {int32Values: [Constants::LIGHT_STATE_ON]}
- **Areas**:
...
- **Requires Permission (Read)**: Car.PERMISSION_PRIVILEGED_CAR_INFO
- **Protection Level**: signature|privileged
- **Version**: 1
- **Default Value**: {int32Values: [2]}
- **Data Type**: int32
...
- **Change Mode**: VehiclePropertyChangeMode.STATIC
- **Access**: VehiclePropertyAccess.READ
- **Requires Permission (Read)**: Car.PERMISSION_READ_ULTRASONICS_SENSOR_DATA
- **Protection Level**: signature|privileged
- **Version**: 3
- **Areas**:
  - **Area ID**: 1
...
- **Change Mode**: VehiclePropertyChangeMode.ON_CHANGE
- **Access**: VehiclePropertyAccess.READ_WRITE, VehiclePropertyAccess.READ
- **Requires Permission (Read)**: Car.PERMISSION_READ_VALET_MODE OR Car.PERMISSION_CONTROL_VALET_MODE
- **Requires Permission (Write)**: Car.PERMISSION_CONTROL_VALET_MODE
- **Protection Level**: signature|privileged
- **Version**: 3
- **Default Value**: {int32Values: [0]}
- **Data Type**: int32
...
- **Requires Permission (Read)**: Car.PERMISSION_CAR_DRIVING_STATE
- **Protection Level**: signature|privileged
- **Version**: 3
...
- **Change Mode**: VehiclePropertyChangeMode.ON_CHANGE
- **Access**: VehiclePropertyAccess.READ_WRITE
- **Requires Permission**: Car.PERMISSION_VMS_PUBLISHER OR Car.PERMISSION_VMS_SUBSCRIBER
- **Protection Level**: signature|privileged
- **Version**: 1
- **Data Type**: mixed
...
- **Access**: VehiclePropertyAccess.READ
- **Unit**: VehicleUnit.MILLI_SECS
- **Requires Permission (Read)**: Car.PERMISSION_READ_WINDSHIELD_WIPERS
- **Protection Level**: signature|privileged
- **Version**: 2
- **Default Value**: {int32Values: [0]}
- **Areas**:
...
- **Requires Permission (Read)**: Car.PERMISSION_READ_WINDSHIELD_WIPERS OR Car.PERMISSION_CONTROL_WINDSHIELD_WIPERS
- **Requires Permission (Write)**: Car.PERMISSION_CONTROL_WINDSHIELD_WIPERS
- **Protection Level**: signature|privileged
- **Version**: 2
